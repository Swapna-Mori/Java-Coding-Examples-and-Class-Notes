...
//		System.out.println(integerData1);
		...
		/*System.out.println("Enter the value of object to remove......");
		Integer value = sc.nextInt();
		if(integerData.remove(value)) {
			System.out.println("removed the object");
		}else {
			throw new ObjectNotFoundException("Object not found with value =  " + value);
		}
		System.out.println("Values after removing the specified object");
		for(int i =0;i<integerData.size();i++) {
			System.out.println(integerData.get(i));
		}
		
		System.out.println("Enter the index to remove object......");
		int index = sc.nextInt();
		integerData.remove(index);
